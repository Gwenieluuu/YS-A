...
task = Task.create(project_name='YOLOv5-v6.2', task_name='train_alga_ten')
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/algadatas.yaml', help='dataset.yaml path')
